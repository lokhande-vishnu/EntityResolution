...
%RUN EXACT ILP SOLVER FOR PRICING
[sol,cost,heur,used_psi]=jy_price_ising_clean(G.Q.prob_list{num_inst},lambda,C.c3_list,psi,G.Q.inst_cost,[],[],G.Q.optimal_ilp_obj(num_inst));
sol=sol(1:G.B.Nd);
