...
manual_clusters = exp + 'VAL_csv_example_golden.csv'
dedupe_clusters_HC = exp + 'VAL_csv_example_output.csv'
dedupe_clusters_FMWSP = exp + 'VAL_F-MWSP_csv_example_output.csv'
...
if __name__ == '__main__':
    ...
    true_dupes, true_list = dupePairs(manual_clusters, 'True Id')
    test_dupes, test_list = dupePairs(dedupe_clusters_HC, 'Cluster ID')
    print(len(true_list))
    print(len(test_list))
    ...
    true_dupes, true_list = dupePairs(manual_clusters, 'True Id')
    test_dupes, test_list = dupePairs(dedupe_clusters_FMWSP, 'Cluster ID')
    print(len(true_list))
    print(len(test_list))
    assert(len(true_list) == len(test_list))
    evaluateDuplicates(test_dupes, true_dupes)
