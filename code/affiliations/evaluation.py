...
zeus_output_file = exp + 'VAL_F-MWSP_aff_output.csv'
val_golden_file = exp + 'VAL_aff_golden.csv'
manual_clusters = exp + 'VAL_aff_golden.csv'
dedupe_clusters_HC = exp + 'VAL_aff_output.csv'
dedupe_clusters_FMWSP = exp + 'VAL_F-MWSP_aff_output.csv'
row_id_name = 'id1'
