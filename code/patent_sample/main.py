...
golden_file = 'patstat_reference.csv'
output_file = exp + 'VAL_patstat_output.csv'
...
print('split data ...')
train_data_d, train_label_d, val_data_d, val_label_d = split(data_d, label_d,
                                                            split_ratio = 0.5,
                                                            seed = seed)
