...
for(n=1: G.B.num_pricing  )
	...
	[prob_list{n},extra_info]=jy_form_ising(G.Q.E,G.Q.pair,G.Q.unary,var_keep,[],0,1,1,G.opt.ILP_opts_cplex,G.opt.int_lin_prog_opt,[],-2);
...
if(in_params.use_heur>0.5)
	G.B.pricing_command_heur='pricing_heur';
