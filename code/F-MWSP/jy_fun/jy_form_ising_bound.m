...
function [Z,extra_info]=jy_form_ising(E,pair,unary,var_keep,hard_exclude_cliques,do_repeat_check,has_cplex_opt,has_matlab_opt,cplex_opt,matlab_opt,inds_force_on,inds_integ,max_nodes)%
%
%purpose
...
%		%-3:  
%	
%	max_nodes:  max number of nodes to include
%
%Output
%
...
node_const=[ones(1,N_d),zeros(1,N_e)];
A=[node_const;1-node_const];
B=[max_nodes;max_nodes*(max_nodes-1)/2];
